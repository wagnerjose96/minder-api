...
public class EnderecoController {
	...
	@GetMapping
	public ResponseEntity<Optional<List<Endereco>>> getenderecos(@RequestHeader String token)
	...
	@GetMapping("/{id}")
	public ResponseEntity<Endereco> getenderecoPorId(@PathVariable EnderecoId id, @RequestHeader String token)
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Optional<String>> deletarSexo(@PathVariable EnderecoId id, @RequestHeader String token)
			throws Exception, AccessDeniedException {
		if (autentica.autenticaRequisicao(token)) {
			if (verificaEnderecoExistente(id)) {
